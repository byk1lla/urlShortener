...
<div class="flex items-center justify-center min-h-screen">
    <div class="bg-gray-800 p-6 rounded-lg shadow-md text-center">
        ...
        <h1 class="text-2xl font-semibold mb-2">Error 401 - Unauthorized</h1>
        <p class="text-lg mb-4">Üzgünüz, bu sayfaya erişebilmek için <span class="font-semibold">Oturum açman</span> gerekiyor.</p>
